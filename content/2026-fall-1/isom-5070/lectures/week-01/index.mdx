...
<QA q="请解释 Prevention、Mitigation、Remediation 三者的区别，并各举一个网络安全的例子。">
...
<QA q="列举风险评估的 5 个主维度（Primary Dimensions）并各用一句话解释。">
...
<QA q="为什么说「Risks DO NOT have a single consequence」？请结合 CrowdStrike 2024 案例说明。">
...
<QA q="比较中国、欧盟、美国网络安全法律监管的核心差异（至少从 3 个维度）。">
...
<QA q="解释 CIA+2（五性）分别代表什么，并说明 InfoSec 的四大关注领域。">
...
<QA q="为什么说 Cyber Security Risk 应该被纳入企业整体的 ERM 框架，而不只是 IT 部门的问题？请列举至少 3 个治理角色及其职责。">
...
<QA q="中国的 CSL、DSL、PIPL 三部法律分别管什么？它们之间是什么关系？">
