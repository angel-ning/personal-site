...
const dict = {
  ...
  notes: {
    ...
    exportMd: { en: "Markdown (.zip)", zh: "Markdown（.zip）" },
    exportMdHint: { en: "Plain Markdown with all images", zh: "纯 Markdown 文件 + 全部图片" },
    exportPdf: { en: "PDF", zh: "PDF" },
    exportPdfHint: { en: "Print layout — choose “Save as PDF”", zh: "打印版式，在打印窗口选「存储为 PDF」" },
